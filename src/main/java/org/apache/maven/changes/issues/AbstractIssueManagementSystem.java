 ...
 * under the License.
 */
package org.apache.maven.changes.issues;

import java.util.HashMap;
import java.util.Map;

import org.apache.maven.changes.changes.IssueAdapter;
import org.apache.maven.changes.changes.IssueType;
...
public abstract class AbstractIssueManagementSystem implements IssueManagementSystem {
    ...
    /*
     * (non-Javadoc)
     * @see org.apache.maven.changes.issues.IssueManagementSystem#getIssueTypeMap()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.apache.maven.changes.issues.IssueManagementSystem#getName()
     */
    public abstract String getName();

    /*
     * (non-Javadoc)
     * @see org.apache.maven.changes.issues.IssueManagementSystem#applyConfiguration(java.util.Map)
     */
